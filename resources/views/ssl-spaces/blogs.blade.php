...
<body id="features-page">
    ...
    <div class="container">
        ...
        <div class="row">
            <div class="main-sec">
                <h1 class="first-blog text-center" data-aos="">
                    Our Thoughts
                </h1>
            </div>
        </div>
        ...
        <div class="row">
            <div class="col-lg-6 col-md-12 col-sm-12 first-blog-sec" data-aos="">
                <a href="{{route('blog-demo')}}">
                    <img class="img-fluid img-blog-top" src="{{asset('images/blog-1.jpg')}}" alt="">
                </a>
                <div class="text-blog py-3">
                    <a href="{{route('blog-demo')}}" style="text-decoration: none;color:#000;">
                ...
                <div class="row">
                    <div class="col-lg-6 col-md-6 col-sm-6">
                        <div class="row">
                            <div class="col-lg-2 col-md-2 col-sm-2">
                                <img style="height: 30px;" class="img-fluid" src="{{asset('images/Signature-icon.png')}}" alt="">
                            </div>
                    ...
                    <div class="col-lg-6 col-md-6 col-sm-6 px-3">
                        <p class="row-float-right-blog text-end">9 April, 2023</p>
                    </div>
                </div>
            </div>
            <div class="col-lg-6 col-md-12 col-sm-12 second-blog-sec" data-aos="">
                <a href="{{route('blog-demo')}}">
                    <img class="img-fluid img-blog-top" src="{{asset('images/blog-2.jpg')}}" alt="">
                </a>
                <div class="text-blog py-3">
                    <a href="{{route('blog-demo')}}" style="text-decoration: none;color:#000;">
                        <h3 class="blog-heading">
        ...
        <div class="row pt-5">
            <div class="col-lg-6 col-md-12 col-sm-12 third-blog-sec" data-aos="">
                <a href="{{route('blog-demo')}}">
                    <img class="img-fluid img-blog-top" src="{{asset('images/blog-3.jpg.png')}}" alt="">
                </a>
                <div class="text-blog py-3">
                    <a href="{{route('blog-demo')}}" style="text-decoration: none;color:#000;">
                        <h3 class="blog-heading">
                            Top 10 Best Coworking Spaces in Lahore
                        </h3>
                    </a>
                    <p class="blog-des">
            ...
            <div class="col-lg-6 col-md-12 col-sm-12 forth-blog-sec" data-aos="">
                <a href="{{route('blog-demo')}}" style="text-decoration: none;color:#000;">
                    <img class="img-fluid img-blog-top" src="{{asset('images/blog-4.png')}}" alt="">
                </a>
                <div class="text-blog py-3">
                    <a href="{{route('blog-demo')}}" style="text-decoration: none;color:#000;">
                        <h3 class="blog-heading">
        ...
        <div class="row pt-5">
            <div class="col-lg-6 col-md-12 col-sm-12 fiveth-blog-sec" data-aos="">
                <a href="{{route('blog-demo')}}" style="text-decoration: none;color:#000;">
                    <img class="img-fluid img-blog-top" src="{{asset('images/blog-5.jpg')}}" alt="">
                </a>
                <div class="text-blog py-3">
                    <a href="{{route('blog-demo')}}" style="text-decoration: none;color:#000;">
                        <h3 class="blog-heading">
            ...
            <div class="col-lg-6 col-md-12 col-sm-12 sixth-blog-sec" data-aos="">
                <a href="{{route('blog-demo')}}">
                    <img class="img-fluid img-blog-top" src="{{asset('images/blog-6.jpg')}}" alt="">
                </a>
                <div class="text-blog py-3">
                    <a href="{{route('blog-demo')}}" style="text-decoration: none;color:#000;">
                        <h3 class="blog-heading">
